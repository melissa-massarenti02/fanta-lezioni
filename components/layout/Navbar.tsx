...
import { LayoutDashboard, Trophy, Timer, BookMarked, LogOut, Zap } from "lucide-react";
                ...
                {navItems.map(({ href, label, icon: Icon }) => {
                    ...
                    return (
                        <Link
                            key={href}
                            href={href}
                            className={`flex flex-col md:flex-row items-center justify-center md:justify-start gap-1 md:gap-3 p-3 rounded-xl transition-all duration-200 group ${active
